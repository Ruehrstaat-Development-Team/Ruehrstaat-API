...
var (
	...
	ErrInvalidAudience         = errors.New(1016, *ErrPackageAuth, 401, "", "Invalid token audience")
	ErrPasswordTooWeak         = errors.New(1017, *ErrPackageAuth, 400, "", "Password does not meet security requirements")
	ErrInvalidRedirectUrl      = errors.New(1018, *ErrPackageAuth, 400, "", "Invalid redirect url")
	ErrInvalidFido2Ceremony    = errors.New(1019, *ErrPackageAuth, 400, "", "Invalid FIDO2 ceremony")
	...
	ErrUserOtpRateLimited           = errors.New(2013, *ErrPackageAuth, 429, "", "Too many invalid OTP attempts")
	ErrRecentAuthenticationRequired = errors.New(2014, *ErrPackageAuth, 428, "", "Recent authentication required")
	...
	ErrDuplicateFidoDisplayName = errors.New(3006, *ErrPackageAuth, 409, "", "FIDO display name already exists")
	...
	ErrLoginRateLimited               = errors.New(9004, *ErrPackageAuth, 429, "", "Too many failed login attempts")
	ErrPasswordResetRateLimited       = errors.New(9005, *ErrPackageAuth, 429, "", "Too many password reset requests")
	ErrRegistrationRateLimited        = errors.New(9006, *ErrPackageAuth, 429, "", "Too many registration attempts")
	ErrEmailAmbiguous                 = errors.NewWithInternalMessage(9007, *ErrPackageAuth, 500, "", "Email is ambiguous", "Multiple users share the same normalized email")
	ErrQuickloginRateLimited          = errors.New(9008, *ErrPackageAuth, 429, "", "Too many failed quicklogin verification attempts")
	ErrQuickloginRequestRateLimited   = errors.New(9009, *ErrPackageAuth, 429, "", "Too many quicklogin token requests")
	ErrPassiveLoginRequestRateLimited = errors.New(9010, *ErrPackageAuth, 429, "", "Too many passive login token requests")
	ErrPassiveLoginRateLimited        = errors.New(9011, *ErrPackageAuth, 429, "", "Too many failed passive login verification attempts")
)
